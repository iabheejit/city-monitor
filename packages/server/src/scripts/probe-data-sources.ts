...
const PROBE_SPECS: ProbeSpec[] = [
  ...
  {
    id: 'hmis-subdistrict',
    name: 'HMIS sub-district maternal indicators',
    kind: 'data-gov',
    resourceId: 'f7fce53f-d46a-4f8f-ae3a-0d5f2937e98d',
  },
  {
    id: 'myscheme-search',
  ...
  // --- Tier 1 new candidates ---
  {
    id: 'jjm-fhtc-district',
    name: 'Jal Jeevan Mission – District FHTC progress',
    kind: 'data-gov',
    resourceId: '7db95e3c-f93f-4b49-b8fc-7d9f2498cdc8',
    filters: { StateName: 'Maharashtra' },
    note: 'JJM household tap connections by district',
  },
  {
    id: 'jjm-fhtc-alt',
    name: 'JJM FHTC coverage (alt resource)',
    kind: 'data-gov',
    resourceId: 'b13a8d16-c9a4-4ef5-a20e-52553b62d72e',
    filters: { StateName: 'Maharashtra' },
    note: 'Alternate resource ID for JJM coverage',
  },
  {
    id: 'swachh-survekshan',
    name: 'Swachh Survekshan 2023 city scores',
    kind: 'data-gov',
    resourceId: '1d5f9578-f3de-4b54-b2fe-79ee86b17bc3',
    filters: { state: 'Maharashtra' },
    note: 'Annual urban cleanliness survey scores',
  },
  {
    id: 'swachh-survekshan-alt',
    name: 'Swachh Survekshan scores (alt resource)',
    kind: 'data-gov',
    resourceId: 'a9126f70-9e80-4fc0-a0bb-7b70e93f3b21',
    filters: { State: 'Maharashtra' },
    note: 'Alternate resource ID for Swachh Survekshan',
  },
  {
    id: 'hmis-district-monthly',
    name: 'HMIS district monthly maternal health (NHM MH)',
    kind: 'data-gov',
    resourceId: '6d9b7f00-a665-4b74-b0ff-cc39fa2c8a70',
    filters: { state_name: 'Maharashtra', district: 'Nagpur' },
    note: 'HMIS monthly district-level health indicators',
  },
  {
    id: 'hmis-district-alt',
    name: 'HMIS district health (alt resource)',
    kind: 'data-gov',
    resourceId: 'd8e1a76f-5832-4e22-b4db-4e0c06a93c83',
    filters: { State: 'Maharashtra' },
    note: 'Alternate HMIS district monthly resource',
  },
  {
    id: 'hospital-nhp-directory',
    name: 'Government hospital directory (NHA)',
    kind: 'data-gov',
    resourceId: 'a90f5dba-7f5e-41d4-8059-a34b547caa75',
    filters: { State: 'Maharashtra', District: 'Nagpur' },
    note: 'Public hospital list with beds, type, address',
  },
  {
    id: 'blood-bank-mh',
    name: 'Licensed blood banks Maharashtra',
    kind: 'data-gov',
    resourceId: 'fded4f6b-8bef-483a-88e1-d26a4e9d0a08',
    filters: { state: 'Maharashtra', district: 'Nagpur' },
    note: 'NACO blood bank directory',
  },
  {
    id: 'tb-district-notifications',
    name: 'TB district case notifications (NTEP)',
    kind: 'data-gov',
    resourceId: 'e9042c44-e4ad-43b7-ae48-a48c85764cfe',
    filters: { State: 'Maharashtra' },
    note: 'Annual TB case counts by district',
  },
  {
    id: 'udise-schools-mh',
    name: 'UDISE+ school count Maharashtra',
    kind: 'data-gov',
    resourceId: '65ac234b-a4e8-4b2c-b3a7-5e6f8d9c0a1b',
    filters: { state: 'Maharashtra', district: 'Nagpur' },
    note: 'School-level infra: enrolment, teachers, facilities',
  },
  {
    id: 'mgnrega-financial-mh',
    name: 'MGNREGA financial progress Maharashtra',
    kind: 'data-gov',
    resourceId: '51e7e9d7-b86a-4aa5-8f43-4c2f2b9c6e8d',
    filters: { State_name: 'Maharashtra' },
    note: 'Financial progress incl. expenditure by district',
  },
  {
    id: 'e-shram-workers',
    name: 'e-Shram unorganised worker registrations',
    kind: 'data-gov',
    resourceId: '4b8f2a19-c3e7-4d56-8b2a-9f1c4e7d0a3e',
    filters: { state: 'Maharashtra' },
    note: 'e-Shram portal worker registration by district',
  },
  {
    id: 'smart-cities-projects',
    name: 'Smart Cities Mission project tracker',
    kind: 'data-gov',
    resourceId: 'cbf4e9d3-5ab3-4d8c-b88e-ca1282c26f72',
    filters: { city: 'Nagpur' },
    note: 'SCM project completion/status for Nagpur',
  },
  {
    id: 'pm-vishwakarma',
    name: 'PM Vishwakarma scheme registrations',
    kind: 'data-gov',
    resourceId: 'f3a9c2b7-8e1d-4f5a-9c3b-2d7e6f8a4c1d',
    filters: { State: 'Maharashtra', District: 'Nagpur' },
    note: 'PM Vishwakarma artisan registration by trade',
  },
];
